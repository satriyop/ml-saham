...
def explore_text(*, verbose: bool = False) -> str:
    lines = [
        ...
        "",
        "Opsi pendekatan",
        "  1) Persentase Saham Sektor > SMA-20 (Sector Breadth %)",
        "  2) PCA Sector Breadth Factor (Primary Breadth Component)",
        "  3) Rank IC Breadth Sektor vs Forward Return Sektor",
        "",
        "Caveat",
...
def run_demo(ctx: ChapterContext) -> DemoResult:
    ...
    # Compute PCA Sector Breadth Factor across stocks
    X_stock = []
    for t in tickers:
        sec = sector_map.get(t, "Other")
    ...
    lines = [
        ...
        f"PCA Primary Sector Breadth Factor explained var: {explained_var:.1%}",
    ...
    return DemoResult(
        title="Sector breadth · market participation index",
        lines=lines,
        metrics=metrics,
