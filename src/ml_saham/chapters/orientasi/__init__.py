...
def run_demo(ctx: ChapterContext) -> DemoResult:
    ...
    summary = (
        ...
        "## Challenge gate\n\n"
        "Jalankan `ml-saham vet` atau "
        "`ml-saham learn compare data-integrity --baseline coverage --against integrity` "
        "sebelum `ml-saham challenge health` jika observation tipis.\n\n"
        "## Caveat\n\n"
        "- Bukan saran trading / investasi.\n"
